...
export const NAV_DATA: NavData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
       ...
       {
        icon: 'https://cdn.vuetifyjs.com/docs/images/logos/vuetify-logo-v3-dark.svg',
        title: 'Vuetify',
        desc: 'Vuetify 是一个用于 Vue.js 的 Material Design 组件框架',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://www.handsome-css.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.5080f6aa.png&w=1920&q=75',
        title: 'AwA UI',
        desc: '纯css实现的各种效果',
        link: 'https://www.handsome-css.com',
      },
    ],
  },
  {
