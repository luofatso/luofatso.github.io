export default [
  ...
  `眼里要有星星，才能照亮昏暗处的自己。最晚不过大器晚成，最差不过独自一人。`,
  `人与人之间的交流，也有个无法避免的规律：混得越熟，矛盾就越容易凸显。`,
  `检验一个人的标准，就是看他把时间放在了哪儿。别自欺欺人；当生命走到尽头，只有时间不会撒谎。`,
  `其实，真正能击垮你的，从来不是别人的非议，而是你对自己的怀疑。`,
  `如今我不太重视自己的想法，也发现少了好多事，人生因无谓消耗的减少，变得轻松而有意义多了。`,
  `我们和某个人一定会相遇两次，一次是彼此年龄相同的时候，另一次是当我到达对方年龄的时候。`,
  `做一个识趣的人,不为难别人,不让自己难堪。`,
  `两个人的沟通70%是情绪，30%是内容，如果沟通情绪不对，那内容就会给扭曲了。`,
  `不为往事扰，余生只愿笑。`,
  `不要将就自己，不要敷衍生活。再忙碌，也要留一些诗意、存一些柔软。`,
  `一个人，初次见面就将你引为知己，迫切想要和你建立信任关系，那你就得警惕了。`,
  `上班是一件成本高且不快乐的“大事”，所以能有一点点的快乐小事，人便知足了。`,
  `我们被自己的生活、兴趣和挑选的所有安慰品维系着，但是我们不能只拥有这些东西，因为那样就无法确定自己该去往何处。`,
  `记忆经过发酵，散发出美丽的味道，弥漫在空气中。痛苦阶段的那些痛苦已经消失，接下来的人生还是一张白纸。`,
  `升学、升职、恋爱、生死、团聚、离散，都是人生中的必然，为什么要去祈祷？`,
  `“后来”真是个神奇的词语，仿佛可以衔接一切变化而不突兀，其实都是时间的功劳。`,
  `大多数人擅长焦虑，给他人制造焦虑的同时，也从未轻易放过自己。`,
  `再也谈不了校园恋爱，也从没谈过校园恋爱。你以为你等待的是爱情，其实错过了整个青春。`,
  `我们在表达恨的时候是天才，而到了爱面前我们就如此平庸。`,
  `我们已经丧失了感受快乐的能力，要慢慢地重新培养这种能力。`,
  `年轻不过是人生的一段过程，切忌在这个过程之中乱认了归宿，不管是事业的归宿，还是感情的归宿。`,
  `在不同里找相同，在无常中找共情，越活越能明白那句话——越不爱人间，越觉人间好。`,
  `一味的空想却不行动，最终往往就变成焦虑和拖延。`,
  `每个人的理解和感受不一样，没法强求的，所以没有标准答案。`,
  `走今天的路,过当下的生活,日子总是温柔又闪光。`,
  `心中有火，眼中有光。你所热爱的，就是你的生活。`,
  `秋天的性格太像人了，很荒凉，但又似乎隐含某种希望。`,
  `如果你太在意别人的看法，那么你的生活将变成一件裤衩。别人放什么屁，你都得接着。`,
  `真正能够长久的关系，不在于得到的一些如梦如幻的短暂快乐。而取决于接受关系里最黑暗部分的承受力。`,
  `请记得那些对你好的人，因为他本可以不这样。`,
  `人生只有回不去，没有什么过不去。`,
  `人的喜好总是相似的，而且长久难改，不管是对事还是对人。`,
  `你知道我是怎么看待生活的吗？在这个难题和下一个难题之间的空白时间，我将它称之为生活。`,
  `看不到细节的人，什么都不知道。而什么都不知道的人，会无意识地变得冷酷。`,
  `人生最危险的敌人，不是你眼中最坏的别人，而是情绪失控时的自己。`,
  ...
  `自己要做得了主。`,
  `为人的悲哀，就像漂泊无依的浮云。`,
  `玩笑就是用幽默把艰难的现实裹起来，防止它变成大爆发的风洞。`,
  `小的时候，什么都会惊奇，也什么都忘得快，快乐也是，烦恼也是。`,
  `关于年轻，只有一种准则，请你翻阅我，但切勿指正`,
  `很多人是很烦别人给建议的，他们认为你教他做事就是觉得他不行。`,
  `既然选择了小众的活法，就不会去在意大众的眼光。`,
  `人生会有遗憾，但不必回头，因为往回走叫重蹈覆辙，往前走，才叫自我治愈。`,
  `青春是打开就合不上的书，人生是踏上了就回不了头。`,
  `世界本来就是迷宫，没有必要再建一座。`,
  `没有人关心你快不快乐，所有人都会看你有没有用。`,
  `一开始的斗志和干劲很重要，但更重要的，是坚持下去的勇气。`,
  `等你发现时间是贼了,它早已偷光你的选择。`,
  `每个人心头都有一把火，我们却时常将自己隐藏得连烟都不让别人瞧见。`,
  `我们既要学会植根在某处，又要学会随心流动。`,
  `我们有时候希望从别人那里得到一个答案或者一个宽慰，但我们只得到一份事不关己的态度。`,
  `真诚这张牌，配合别的牌一起出是王牌，唯独单独出时，是张烂牌。`,
  `人生就是一本回忆录，越久远越模糊，越久远越美好。`,
  `我就是不喜欢听到别人把所有人都称为自己的“朋友”。我似乎很珍视这个词。`,
  `越不爱人间，越觉人间好。人间很好但下辈子不太想来了。`,
  `人可以失落一切，唯独不应该失落自己。`,
  `别说什么木克水、水克土，土克火，火克金，只要你穷，什么都克你。`,
  `每一个人的生活，各有各的隐情，各有各的来由，各有各的寂寞，也最终各有各的前程。`,
  `上班，下班，归家路，三点一线的生活，如并不合身的外衣，强行套在每个不同尺寸人身上。`,
  `我做出了选择。也许不是好的选择，但选择了就要承担后果。`,
  `你要的不是崭新的开始，你要的是行动，从而转向一个崭新的结局。`,
  `我想躲进一个不会被人看到的角落。我想遗忘自己。`,
  `生活的本质就是平淡的，接受它，然后尽最大的努力让自己开心。`,
  `要在不愉快的日子里，搜刮生活藏起来的温柔。`,
  `是金子在哪都会发光，是孙子在哪都会心慌。`,
  `冬天了 ，我们应该 ，靠近一点儿`,
  `在人的一生中常常有一段时间，只要他有一点儿演戏的才能，就会连他自己也欺骗过去。`,
  `白天和黑夜，人的生活可能分为两种，一边现实，一边理想。我们在两种生活之间徘徊，真实与梦幻的边界并没有那么清晰。`,
  `成长，让我们说过的每一句大话，都蒙上了一层羞耻的灰。`,
  `世界上并不存在“理解”这样一回事。所谓理解，不过是一种被动接受罢了，而所谓的不理解，无非就是某种程度上的对抗。`,
  `我们有时像过客，有时像主人翁，有时又像城市的孤儿。`,
  `人的选择题不是只有A和B，判断题也不是只有对和错，慢慢看，慢慢学。`
]
