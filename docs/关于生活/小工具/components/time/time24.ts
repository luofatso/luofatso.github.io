export const weekStrArr = ['星期日', '星期一', '星期二', '星期三', '星期四', '星期五', '星期六']

export const time24 =
  '立春、雨水、惊蛰、春分、清明、谷雨、立夏、小满、芒种、夏至、小暑、大暑、立秋、处暑、白露、秋分、寒露、霜降、立冬、小雪、大雪、冬至、小寒、大寒'

export const time24Obj: any = {
  立春: {
    title: '东风解冻、蛰虫始振、鱼上冰。',
    intro: [
  ...
  春分: {
    ...
    custom: [
      '1.竖蛋：春分成了竖蛋游戏的最佳时光，故有“春分到，蛋儿俏”的说法。',
      '2.吃春菜：“春分吃春菜”。“春菜”是一种野苋菜，乡人称之为"春碧蒿"。逢春分那天采回的春菜一般家里与鱼片“滚汤”，名曰“春汤”。',
      ...
      '5.春祭：二月春分，开始扫墓祭祖，也叫春祭。扫墓前先要在祠堂举行隆重的祭祖仪式，杀猪、宰羊，请鼓手吹奏，由礼生念祭文，带引行三献礼。',
      '6.祭日：在周代，春分有祭日仪式。此俗历代相传。清潘荣陛《帝京岁时纪胜》：“春分祭日，秋分祭月，乃国之大典，士民不得擅祀。”'
    ],
    life: [
  ...
  清明: {
    title: '桐始华、鼠化为鴽、虹始见。',
    intro: [
      '清明节，英文标准译名：Tomb-sweeping Day或者Pure Brightness。是中国的二十四节气之一，每年的阳历四月五日左右。',
  ...
  谷雨: {
    title: '萍始生、鸣鸠拂其羽、戴胜降于桑。',
    intro: [
      '谷雨是春季的最后一个节气，这时田中的秧苗初插、作物新种，最需要雨水的滋润，所以说“春雨贵如油”。谷雨是“雨生百谷”的意思，每年4月20日或21日太阳到达黄经30°时为谷雨。'
    ],
    origin: [
      '《月令七十二候集解》： “三月中，自雨水后，土膏脉动，今又雨其谷于水也。谷雨时节作去声，如雨我公田之雨。盖谷以此时播种，自上而下也。”，故此得名。',
  ...
  立夏: {
    ...
    custom: [
      '立夏日。对今人来说，立夏不过是一个节气，表明春天结束，夏日由此开始而已。可是，我们的先人却把立夏当作一个重要的日子来对待。旧俗立夏日又为民间传统节日，称“立夏节”。古代天子率百官迎夏于南郊，并举行祭祀炎帝、祝融的仪式。到明代民间始有尝新风俗，清代更有祭神、尝新、馈节、秤人、烹新茶等习俗。',
      '江浙一带至今仍保留吃立夏蛋、健脚笋、五虎丹、三两半等“吃补食”的饮食风俗；云南宣威地区则有大门插皂荚枝、红花以压崇，围灰墙脚以避蛇之俗。中国部分少数民族亦有过立夏节的习俗。'
    ],
    life: [
  ...
  小暑: {
    title: '温风至、蟋蟀居辟、鹰乃学习。',
    intro: [
      '每年7月7日或8日视太阳到达黄经105°时为小暑。斗指辛。太阳黄经为105°。天气已经很热，但不到是热的时候，所以叫小暑。此时，已是初伏前后。'
    ],
    origin: [
  ...
  立秋: {
    ...
    origin: [
      ...
      '立秋不仅预示着炎热的夏天即将过去，秋天即将来临。也表示草木开始结果孕子，收获季节到了。古人把立秋当作夏秋之交的重要时刻，一直很重视这个节气。'
    ],
    custom: [
  ...
  处暑: {
    ...
    custom: [
      '1.出游迎秋：祭祖、迎秋处暑节气前后的民俗多与祭祖及迎秋有关。处暑前后民间会有庆赞中元的民俗活动，俗称“作七月半”或“中元节”。旧时民间从七月初一起,就有开鬼门的仪式，直到月底关鬼门止，都会举行普渡布施活动。此外，处暑之后，秋意渐浓，正是人们畅游郊野迎秋赏景的好时节。',
      '2.放河灯：河灯也叫“荷花灯”，一般是在底座上放灯盏或蜡烛，中元夜放在江河湖海之中，任其漂泛。放河灯是为了普渡水中的落水鬼和其他孤魂野鬼。',
      '3.开渔节：对于沿海渔民来说，处暑以后渔业收获的时节，因为，这时海域水温依然偏高，鱼群还是会停留在海域周围，鱼虾贝类发育成熟。因此，从这一时间开始，人们往往可以享受到种类繁多的海鲜。'
    ],
    life: [
  ...
  白露: {
    title: '鸿雁来、玄鸟归、群鸟养羞。',
    intro: [
      '白露是24节气之一，此时气温开始下降，天气转凉，早晨草木上有了露水。每年公历的9月7日前后是白露。'
    ],
    origin: [
    ...
    life: [
      ...
      '白露时节要预防秋燥，燥邪伤人，容易耗人津液，而出现口干、唇干、鼻干、咽干及大便干结、皮肤干裂等症状。预防秋燥的方法很多，可适当地多服一些富含维生素的食品，也可选用一些宣肺化痰、滋阴益气的中药，如人参、沙参等，对缓解秋燥有良效。'
    ]
  },
  秋分: {
    title: '雷始收声、蛰虫培户、水始涸。',
    ...
    origin: [
      '我国古籍《春秋繁露·阴阳出入上下篇》中说：“秋分者，阴阳相半也，故昼夜均而寒暑平。”秋分之“分”为“半”之意。秋分“秋分”的意思有二：一是太阳在这一天到达黄经180度，直射地球赤道，因此这一天24小时昼夜均分，各12小时；全球无极昼极夜现象。秋分之后，北极附近极夜范围渐大，南极附近极昼范围渐大。二是按我国古代以立春、立夏、立秋、立冬为四季开始的季节划分法，秋分日居秋季90天之中，平分了秋季。'
    ],
    custom: [
  ...
  寒露: {
    ...
    custom: [
      '登高习俗：如果说白露时节天气转凉，开始出现露水，那么到了寒露，则露水增多，且气温更低。此时我国有些地区会出现霜冻，北方已呈深秋景象，白云红叶，偶见早霜，南方也秋意渐浓，蝉噤荷残。北京人登高习俗更盛，景山公园、八大处、香山等都是登高的好地方，重九登高节，更会吸引众多的游人。',
      '农事习俗：寒露时天气对秋收十分有利，农谚有“黄烟花生也该收，起捕成鱼采藕芡。大豆收割寒露天，石榴山楂摘下来。”寒露蜜桃属北方晚熟桃品种，成熟期在寒露前后，故名“寒露蜜桃”。',
      '饮食习俗：寒露时节，应多食用芝麻、糯米、粳米、蜂蜜、乳制品等柔润食物，同时增加鸡、鸭、牛肉、猪肝、鱼、虾、大枣、山药等以增加体质；少食辛辣之品，如辣椒、生姜、葱、蒜类，因过食辛辣宜伤人体阴精。有条件可以煮一点百枣莲子银杏粥经常喝，经常吃些山药和马蹄也是不错的养生办法。'
    ],
    life: [
  ...
  霜降: {
    ...
    origin: [
      ...
      '古籍《二十四节气解》中说：“气肃而霜降，阴始凝也。”可见“霜降”表示天气逐渐变冷，开始降霜。气象学上，一般把秋季出现的第一次霜叫做“早霜”或“初霜”，而把春季出现的最后一次霜称为“晚霜”或“终霜”。从终霜到初霜的间隔时期，就是无霜期。'
    ],
    custom: [
  ...
  立冬: {
    ...
    origin: [
      '《月令七十二候集解》中对“冬”的解释是：“冬，终也，万物收藏也”，意思是说秋季作物全部收晒完毕，收藏入库，动物也已藏起来准备冬眠。完整地说，立冬是表示冬季开始，万物收藏，规避寒冷的意思。',
      '我国古时民间习惯以立冬为冬季的开始，我国幅员广大，除全年无冬的华南沿海和长冬无夏的青藏高原地区外，各地的冬季并不都是于立冬日同时开始的。',
      ''
    ],
    custom: [
      '立冬与立春、立夏、立秋合称四立，在古代社会中是个重要的节日，这一天皇帝会率领文武百官到京城的北郊设坛祭祀。在现在，人们在立冬之日，也要庆祝一下。',
      '吃饺子：立冬节气，有秋收冬藏的含义，我国过去是个农耕社会，劳动了一年的人们，利用立冬这一天要休息一下，顺便犒赏一家人一年来的辛苦。有句谚语“立冬补冬，补嘴空”就是最好的比喻。',
  ...
  小寒: {
    ...
    custom: [
      '吃菜饭：古时，南京人对小寒颇重视，但随着时代变迁，现已渐渐淡化，如今人们只能从生活中寻找出点点痕迹。到了小寒，老南京一般会煮菜饭吃，菜饭的内容并不相同，有用矮脚黄青菜与咸肉片、香肠片或是板鸭丁，再剁上一些生姜粒与糯米一起煮的，十分香鲜可口。其中矮脚黄、香肠、板鸭都是南京的著名特产，可谓是真正的“南京菜饭”，甚至可与腊八粥相媲美。',
      '吃糯米饭：广州传统，小寒早上吃糯米饭，为避免太糯，一般是60%糯米40%香米，把腊肉和腊肠切碎，炒熟，花生米炒熟，加一些碎葱白，拌在饭里面吃。'
    ],
    life: [
  ...
  大寒: {
    ...
    life: [
      '冬三月是生机潜伏、万物蛰藏的时令，此时人体的阴阳消长代谢也处于相当缓慢的时候，所以此时应该早睡晚起，不要轻易扰动阳气，凡事不要过度操劳，要使神志深藏于内，避免急躁发怒。大寒是冬季六节气之一，此时天气寒冷已极，故名大寒。大寒的养生，要着眼于“藏”。意思是姜羊肉汤补血驱寒说，人们在此期间要控制自己的精神活动，保持精神安静，把神藏于内不要暴露于外。'
    ]
  }
}
