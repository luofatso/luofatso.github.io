import{_ as s,o as n,c as a,a2 as e}from"./chunks/framework.DkMK-_fX.js";const _=JSON.parse('{"title":"插件记录","description":"","frontmatter":{},"headers":[],"relativePath":"大前端/Vue3/vue3好用的插件记录.md","filePath":"大前端/Vue3/vue3好用的插件记录.md","lastUpdated":1728700067000}'),p={name:"大前端/Vue3/vue3好用的插件记录.md"},r=e(`<h1 id="插件记录" tabindex="-1">插件记录 <a class="header-anchor" href="#插件记录" aria-label="Permalink to &quot;插件记录&quot;">​</a></h1><h2 id="用composition-api的思想封装nprogress" tabindex="-1">用Composition API的思想封装NProgress <a class="header-anchor" href="#用composition-api的思想封装nprogress" aria-label="Permalink to &quot;用Composition API的思想封装NProgress&quot;">​</a></h2><p>npm i nprogress @vueuse/integrations</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>//router.js</span></span>
