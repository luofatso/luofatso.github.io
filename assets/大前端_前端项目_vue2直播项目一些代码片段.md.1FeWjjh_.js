import{_ as s,o as n,c as a,a2 as p}from"./chunks/framework.DkMK-_fX.js";const h=JSON.parse('{"title":"直播项目的一些代码片段","description":"","frontmatter":{},"headers":[],"relativePath":"大前端/前端项目/vue2直播项目一些代码片段.md","filePath":"大前端/前端项目/vue2直播项目一些代码片段.md","lastUpdated":1727401527000}'),e={name:"大前端/前端项目/vue2直播项目一些代码片段.md"},l=p(`<h1 id="直播项目的一些代码片段" tabindex="-1">直播项目的一些代码片段 <a class="header-anchor" href="#直播项目的一些代码片段" aria-label="Permalink to &quot;直播项目的一些代码片段&quot;">​</a></h1><p>最近做了一个直播项目，记录一些在其中使用的代码片段。</p><h2 id="多行文本自动撑大" tabindex="-1">多行文本自动撑大 <a class="header-anchor" href="#多行文本自动撑大" aria-label="Permalink to &quot;多行文本自动撑大&quot;">​</a></h2><ul><li>自动无限撑大</li></ul><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;textarea</span></span>
