import{_ as s,o as a,c as n,a2 as e}from"./chunks/framework.DkMK-_fX.js";const h=JSON.parse('{"title":"JS片段","description":"","frontmatter":{},"headers":[],"relativePath":"大前端/JavaScript/JS片段.md","filePath":"大前端/JavaScript/JS片段.md","lastUpdated":1728700067000}'),p={name:"大前端/JavaScript/JS片段.md"},l=e(`<h1 id="js片段" tabindex="-1">JS片段 <a class="header-anchor" href="#js片段" aria-label="Permalink to &quot;JS片段&quot;">​</a></h1><p>[TOC]</p><h2 id="检查当前用户是否为苹果设备" tabindex="-1">检查当前用户是否为苹果设备 <a class="header-anchor" href="#检查当前用户是否为苹果设备" aria-label="Permalink to &quot;检查当前用户是否为苹果设备&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const isAppleDevice = /Mac|iPod|iPhone|iPad/.test(navigator.platform);</span></span>
