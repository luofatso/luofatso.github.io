import{_ as s,o as n,c as a,a2 as p}from"./chunks/framework.DkMK-_fX.js";const g=JSON.parse('{"title":"利用vue-cropper做一个关于图片裁剪、压缩、上传、预览等的公共组件","description":"","frontmatter":{},"headers":[],"relativePath":"大前端/Vue2/图片裁剪、压缩、上传、预览组件.md","filePath":"大前端/Vue2/图片裁剪、压缩、上传、预览组件.md","lastUpdated":1728700067000}'),l={name:"大前端/Vue2/图片裁剪、压缩、上传、预览组件.md"},e=p(`<h1 id="利用vue-cropper做一个关于图片裁剪、压缩、上传、预览等的公共组件" tabindex="-1">利用vue-cropper做一个关于图片裁剪、压缩、上传、预览等的公共组件 <a class="header-anchor" href="#利用vue-cropper做一个关于图片裁剪、压缩、上传、预览等的公共组件" aria-label="Permalink to &quot;利用vue-cropper做一个关于图片裁剪、压缩、上传、预览等的公共组件&quot;">​</a></h1><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;el-form-item label=&quot;头像&quot; prop=&quot;icon&quot; :rules=&quot;rules.required&quot;&gt;</span></span>
