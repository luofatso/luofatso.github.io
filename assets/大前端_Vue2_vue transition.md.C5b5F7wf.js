import{_ as s,o as n,c as a,a2 as p}from"./chunks/framework.DkMK-_fX.js";const h=JSON.parse('{"title":"vue transition","description":"","frontmatter":{},"headers":[],"relativePath":"大前端/Vue2/vue transition.md","filePath":"大前端/Vue2/vue transition.md","lastUpdated":1727401527000}'),e={name:"大前端/Vue2/vue transition.md"},l=p(`<h1 id="vue-transition" tabindex="-1">vue transition <a class="header-anchor" href="#vue-transition" aria-label="Permalink to &quot;vue transition&quot;">​</a></h1><p>Vue 提供了 transition 的封装组件,在下列情形中，可以给任何元素和组件添加进入/离开过渡:</p><ul><li>在 CSS 过渡和动画中自动应用 class</li><li>可以配合使用第三方 CSS 动画库，如 Animate.css</li><li>在过渡钩子函数中使用 JavaScript 直接操作 DOM</li><li>可以配合使用第三方 JavaScript 动画库，如 Velocity.js</li></ul><p>上述为官网原话，为了不成官网的搬用工，我就按自己的思路整理就记录，其实简单理解就是进入和离开的时候他会在相应的时间给你加上 css 的动画。</p><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;div id=&quot;demo&quot;&gt;</span></span>
