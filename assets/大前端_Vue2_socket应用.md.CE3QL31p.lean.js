import{_ as s,o as n,c as a,a2 as p}from"./chunks/framework.DkMK-_fX.js";const h=JSON.parse('{"title":"socket 的应用","description":"","frontmatter":{},"headers":[],"relativePath":"大前端/Vue2/socket应用.md","filePath":"大前端/Vue2/socket应用.md","lastUpdated":1728700067000}'),e={name:"大前端/Vue2/socket应用.md"},l=p(`<h1 id="socket-的应用" tabindex="-1">socket 的应用 <a class="header-anchor" href="#socket-的应用" aria-label="Permalink to &quot;socket 的应用&quot;">​</a></h1><p>socket 这东西我就不做多的介绍了，相信大家都有相应的了解，本人呢也是这个样子的；最近刚好项目中应用了一下，这里记录一下。(本记录为 vue)</p><h2 id="初始化" tabindex="-1">初始化 <a class="header-anchor" href="#初始化" aria-label="Permalink to &quot;初始化&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yarn add vue-socket.io</span></span>
