import{_ as s,o as n,c as a,a2 as p}from"./chunks/framework.DkMK-_fX.js";const l="/assets/css-hide.Hv94TarV.png",e="/assets/css-hide1.N7dy5i9-.png",x=JSON.parse('{"title":"css超出省略","description":"","frontmatter":{},"headers":[],"relativePath":"大前端/Css/css超出省略.md","filePath":"大前端/Css/css超出省略.md","lastUpdated":1728700067000}'),i={name:"大前端/Css/css超出省略.md"},r=p('<h1 id="css超出省略" tabindex="-1">css超出省略 <a class="header-anchor" href="#css超出省略" aria-label="Permalink to &quot;css超出省略&quot;">​</a></h1><p>收起状态 <img src="'+l+'" alt="收起状态"> 展开状态 <img src="'+e+`" alt="展开状态"></p><h2 id="_1-新版" tabindex="-1">1 新版 <a class="header-anchor" href="#_1-新版" aria-label="Permalink to &quot;1 新版&quot;">​</a></h2><p><a href="https://codepen.io/luofatso/pen/MWQZoQE" target="_blank" rel="noreferrer">在线演示</a></p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;!DOCTYPE html&gt;</span></span>
